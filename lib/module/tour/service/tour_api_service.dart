...
class TourApiService {
  ...
  Future<Response> getTourPackagesByDestinationId(String destinationId) async {
    return await dio.get('getTourPackagesByDestinationId/$destinationId');
  }

  Future<Response> getTourPackagesByTravelThemeId(String travelThemeId) async {
    return await dio.get('getTourPackagesByTravelThemeId/$travelThemeId');
  }
}
