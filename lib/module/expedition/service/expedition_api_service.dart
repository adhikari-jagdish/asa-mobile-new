...
class ExpeditionApiService {
  ...
  Future<Response> getExpeditionPackagesByDestinationId(String destinationId) async {
    return await dio.get('getExpeditionPackagesByDestinationId/$destinationId');
  }

  Future<Response> getExpeditionPackagesByTravelThemeId(String travelThemeId) async {
    return await dio.get('getExpeditionPackagesByTravelThemeId/$travelThemeId');
  }
}