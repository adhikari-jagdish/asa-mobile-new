...
class PeakClimbingApiService {
  ...
  Future<Response> getPeakClimbingPackagesByDestinationId(String destinationId) async {
    return await dio.get('getPeakClimbingPackagesByDestinationId/$destinationId');
  }

  Future<Response> getPeakClimbingPackagesByTravelThemeId(String travelThemeId) async {
    return await dio.get('getPeakClimbingPackagesByTravelThemeId/$travelThemeId');
  }
}
